      ...
      <div className="my-cookie-disclaimer-container">
        <div className="w3-content w3-card w3-theme-l1 w3-padding-large w3-center my-round-top w3-border my-cookie-disclaimer">
          <p>
            ...
            other customizations in your browser's <b>local storage</b>. It's
            similar to using cookies, but neither are flawless. This
            application's creator allows this application, if used, to store
            information on your device with the sole purpose of customizing this
